...
<div class="section mt-[22px] px-2 sm:px-0 h-full flex items-center flex-col">
	...
	<div class="bg-white w-full sm:w-7/12 h-full rounded-2xl px-6 py-4 mb-10">
		<form action="controller/add-proc.php" method="post" class="w-full flex flex-col items-center">
			<label class="form-control w-full">
			  ...
			  <input type="text" name="namai" placeholder="Masukan data anda" class="input input-bordered w-full" value="<?= $data['namaIntansi']; ?>" />
			</label>
			<label class="form-control w-full">
			  <div class="label">
