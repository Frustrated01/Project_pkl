...
<body> 
     ...
     <div class="sidebar">
        ...
        <ul>
            <li><a href="data_perencanaan.php"><i class="fa-solid fa-file"></i> Perencanaan</a></li>
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body bg-primary">
                    <h5 class="card-title" style="color: #fff;">Jumlah Data Pra Perencanaan</h5>
                    <p class="card-text" style="color: #fff;"><i class="fa-regular fa-file"></i> 2 Data Tersedia</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body bg-success">
                    <h5 class="card-title" style="color: #fff;">Jumlah Dara Perencanaan</h5>
                    <p class="card-text" style="color: #fff;"><i class="fa-regular fa-file"></i> 1 Data tersedia</p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
