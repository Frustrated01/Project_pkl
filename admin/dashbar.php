<div class="navbar bg-base-100 shadow-md">
	<div class="navbar-start">
		<div class="dropdown">
			...
			<ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[2] p-2 shadow bg-base-100 rounded-box w-52">
				...
				<li><a href="admin.php?halaman=dashboard">DASHBOARD</a></li>
				<li><a href="admin.php?halaman=dataperencanaan">PERENCANAAN</a></li>
				<li><a href="admin.php?halaman=profile">PROFILE</a></li>
				<li><a href="admin.php?halaman=logout">LOGOUT</a></li>
			</ul>
		</div>
	...
	<div class="navbar-end hidden sm:flex">
		<ul class="menu menu-horizontal px-1 font-bold">
			...
			<li class="hover:bg-info hover:text-white rounded-lg"><a href="admin.php?halaman=dashboard">DASHBOARD</a></li>
			<li class="hover:bg-info hover:text-white rounded-lg"><a href="admin.php?halaman=dataperencanaan">PERENCANAAN</a></li>
			<li class="hover:bg-info hover:text-white rounded-lg"><a href="admin.php?halaman=profile">PROFILE</a></li>
