  ...
  <div class="navbar-start">
    <div class="dropdown">
      ...
      <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
          ...
          <li class=""><a href="index.php?page=dashboard">Dashboard</a></li>
          <li class=""><a href="index.php?page=pengajuan">Pengajuan</a></li>
          <li class=""><a href="index.php?page=konsultasi">Balasan</a></li>
      </ul>
    </div>
