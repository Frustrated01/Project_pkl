...
<div class="section w-full mt-[22px] h-screen flex justify-center items-center">
	<div class="p-4 w-[400px] flex flex-col items-center shadow-xl bg-neutral-100 rounded-3xl">
		<div class="bg-base-100 rounded-2xl p-2 w-full flex flex-col items-center shadow-md">
			...
			<form action="controller/auth.php" method="post" class="w-full flex flex-col items-center">
				...
				<label class="form-control w-full">
				  ...
				  <input type="password" minlength="8" pattern="(?=.*\d)(?=.*[a-z]).{8,}" title="Harus berisi setidaknya satu nomor dan huruf kecil, dan paling sedikit 8 karakter atau lebih" name="password" required placeholder="Masukan password anda" class="input input-bordered w-full" />
				</label>
				<label class="form-control w-full">
				  <div class="label">
				    <span class="label-text">Konfirmasi Password</span>
				  </div>
				  <input type="password" minlength="8" pattern="(?=.*\d)(?=.*[a-z]).{8,}" title="Harus berisi setidaknya satu nomor dan huruf kecil, dan paling sedikit 8 karakter atau lebih" name="cpassword" required placeholder="Masukan password anda" class="input input-bordered w-full" />
				</label>
